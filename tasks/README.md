...
`task1472_bengali_reviews_sentiment_classification.json` | Given a restaurant review in Bengali, classify whether the sentiment is positive or negative. | Classification
