...
`task271_europarl_translation.json`| Translate bulgarian sentence into english language | Sentence Generation
`task272_europarl_translation.json`| Translate english sentence into bulgarian language | Sentence Generation
