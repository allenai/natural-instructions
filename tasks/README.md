...
`task268_casehold_answer_generation` | Given a prompt from a judicial decision and multiple potential holdings, choose the correct option | Legal
...
`task274_overruling_classification`	| Given a sentence, classify it into overruling or non-overruling| Legal
