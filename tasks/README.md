...
`task883_Stance_Detection_text_generation` | Given a tweet, clasify it into one of these categories: Atheism, Climate Change is a Real Concern, Feminist Movement, Hillary Clinton, and Legalization of Abortion. | Text Generation
`task884_Stance_Detection_text_generation` | Given a tweet and type of that tweet, generate the stance of the tweet. | Text Generation
