...
`task1699_jnlpba_entity_classification` | Classifying entities (based on jnlpba) | Entity Classification
`task1700_jnlpba_entity_counting` | Counting the bio entities in jnlpba | Count Generation
`task1701_bn_hate_speech_machine_translation` | Translation of records in bn_hate_speech | Machine Translation
`task1702_bn_hate_speech_news_category_classification` | Classifying the news into 5 categories | News Classification 
