...
`task1737-mdd-answer_generation` | Generating answers (based on MDD) | Answer Generation  
`task1738-mdd-recommendation_check` | Recommendation check (based on MDD) |  Recommendation Check
`task1739-mdd-recommendation_check_qa` | Recommendation, QA check (based on MDD) |  Recommendation, QA Check
`task1740-mdd_sentiment_classification` | Sentiment classification (based on MDD) |  Sentiment classification
