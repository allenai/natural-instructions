...
`task297_StoryCloze_incorrect_end_answer_generation` | Given four sentences of five sentence story, select incorrect answer for last (fifth) sentence from the given option. | Answer Generation
