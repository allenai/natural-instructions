...
- `Question Answering`
  ...
  - `Question Answering -> Incorrect Answer Generation`
    - `Question Answering -> Incorrect Answer Generation -> Commonsense Answer Generation`
    - `Question Answering -> Incorrect Answer Generation -> Contextual Answer Generation`
...
* `Commonsense`
  * `Commonsense -> Concepts and Relations`
    * `Commonsense -> Concepts and Relations -> Social Commonsense`: a situation involving two same gender people
with contrasting attributes, emotions, social roles, etc.
    * `Commonsense -> Concepts and Relations -> Physical Commonsense`: a context involving two physical
